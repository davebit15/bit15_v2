			...
			<div class="col-md-12">
				...
				* Use class "heading-uppercase" to enable uppercase letters.
				...
				<div class="heading heading-md heading-center heading-hover wow fadeIn">
					<span class="heading-title-ghost">Clients</span>
					<h2 class="heading-title">Clients</h2>
			...
			<div class="col-md-12 margin-top-60 wow fadeIn" data-wow-delay="0.3s">
				...
				* Available carousel data attributes:
				...
				<div class="owl-carousel clients-carousel dots-outside" data-items="5" data-margin="40" data-tablet-landscape="4" data-tablet-portrait="3" data-mobile-landscape="2" data-mobile-portrait="1">
					...
					========================= -->
					<div class="cc-item">
						<a target="_blank" class="client"><img src="assets/img/clients/mexico-grand-prix.png" alt="image"></a>
					</div>
					<!-- End carousel item -->
					...
					========================= -->
					<div class="cc-item">
						<a target="_blank" class="client"><img src="assets/img/clients/Sony-Music-logo-wordmark.png" alt="image"></a>
					</div>
					<!-- End carousel item -->
					...
					========================= -->
					<div class="cc-item">
						<a target="_blank" class="client"><img src="assets/img/clients/ocesa-logo.png" alt="image"></a>
					</div>
					<!-- End carousel item -->
					...
					========================= -->
					<div class="cc-item">
						<a target="_blank" class="client"><img src="assets/img/clients/BMG_Logo.png" alt="image"></a>
					</div>
					<!-- End carousel item -->
					...
					========================= -->
					<div class="cc-item">
						<a target="_blank" class="client"><img src="assets/img/clients/cazo.png" alt="image"></a>
					</div>
					<!-- End carousel item -->
					...
					========================= -->
					<div class="cc-item">
						<a target="_blank" class="client"><img src="assets/img/clients/logo_nl.png" alt="image"></a>
					</div>
					<!-- End carousel item -->
